      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="flex justify-center">
          <a
            ...
            href={dnsCheckerPageData?.cta?.buttonLink || "/"}
          >
            {dnsCheckerPageData?.cta?.buttonText ||
        ...
        <div className="mt-5 max-w-2xl text-center mx-auto">
          <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
            {dnsCheckerPageData?.cta?.title
              ?.split(" ")
              .slice(0, -1)
              .join(" ") || "Let's Build"}
            <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
              {" "}
              {dnsCheckerPageData?.cta?.title?.split(" ").slice(-1)[0] ||
                "Together"}
            </span>
          </h1>
        </div>
        ...
        <div className="mt-8 grid gap-3 w-full sm:inline-flex sm:justify-center">
          <a
            ...
            href={dnsCheckerPageData?.cta?.leftButtonLink || "#!"}
          >
            {dnsCheckerPageData?.cta?.leftButtonText || "Get Hosting"}
            <svg
              className="w-3 h-3"
              width="16"
              height="16"
          ...
          <a
            ...
            href={dnsCheckerPageData?.cta?.rightButtonLink || "#!"}
          >
            {dnsCheckerPageData?.cta?.rightButtonText || "Get Hosting"}
