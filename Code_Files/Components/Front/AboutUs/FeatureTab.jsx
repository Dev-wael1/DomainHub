...
export default function FeatureTab() {
  const aboutUsPageData = useSelector((state) => state.aboutUsPageData);
  return (
    <>
      {/* Features */}
          ...
          <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
            <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
              <h2 className="text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
                {aboutUsPageData?.featureTab?.title ||
              ...
              >
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        {aboutUsPageData?.featureTab?.tab2Title ||
                          "Advanced tools"}
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        {aboutUsPageData?.featureTab?.tab2Desc ||
                          "Use Preline thoroughly thought and automated libraries to manage your businesses."}
                      </span>
                    </span>
                  </span>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        {aboutUsPageData?.featureTab?.tab3Title ||
                          "Advanced tools"}
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        {aboutUsPageData?.featureTab?.tab3Desc ||
                          "Use Preline thoroughly thought and automated libraries to manage your businesses."}
                      </span>
                    </span>
                  </span>
                ...
                <div>
                  ...
                  >
                    <img
                      ...
                      src={
                        aboutUsPageData?.featureTab?.tab1Image?.split(
                          "public"
                        )[1] ||
                  ...
                  >
                    <img
                      className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]"
                      src={
                        aboutUsPageData?.featureTab?.tab2Image?.split(
                          "public"
                        )[1] ||
                  ...
                  >
                    <img
                      className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]"
                      src={
                        aboutUsPageData?.featureTab?.tab3Image?.split(
                          "public"
                        )[1] ||
