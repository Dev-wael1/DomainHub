      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="flex justify-center">
          <a
            ...
            href={homePageData?.cta?.buttonLink || "/"}
          >
            {homePageData?.cta?.buttonText || "PRO release - Join to waitlist"}
        ...
        <div className="mt-5 max-w-2xl text-center mx-auto">
          <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
            {homePageData?.cta?.title.split(" ").slice(0, -1).join(" ") ||
              "Let's Build"}
            <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
              {" "}
              {homePageData?.cta?.title.split(" ").slice(-1)[0] || "Together"}
            </span>
          </h1>
        </div>
        {/* <!-- End Title --> */}
        ...
        <div className="mt-8 grid gap-3 w-full sm:inline-flex sm:justify-center">
          <a
            ...
            href={homePageData?.cta?.leftButtonLink || "#!"}
          >
            {homePageData?.cta?.leftButtonText || "Get started"}
            <svg
              className="w-3 h-3"
              width="16"
              height="16"
          ...
          <a
            ...
            href={homePageData?.cta?.rightButtonLink || "#!"}
          >
            {homePageData?.cta?.rightButtonText || "Get Discounts"}
