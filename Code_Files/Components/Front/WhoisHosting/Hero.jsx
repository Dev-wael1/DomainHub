...
export default function Hero() {
  ...
  const handleSubmit = (e) => {
    ...
    const check = document.getElementById("check").offsetTop;
    window.scrollTo({ top: check, behavior: "smooth" });
    axios
      .post("/api/who-is-hosting/check-hosting", { inputValue })
      .then((res) => {
          ...
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              <p className="text-xs font-semibold text-gray-700 tracking-wide uppercase mb-3 dark:text-gray-900">
                {whoisHostingPageData?.hero?.topTitle ||
                  "Small business solutions"}
              </p>
              <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-900">
                {whoisHostingPageData?.hero?.mainTitle?.split(".")[0] ||
                  "Turn online shoppers into"}{" "}
              </h1>
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold lg:leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]">
                {whoisHostingPageData?.hero?.mainTitle?.split(".")[1] ||
                  "Turn online shoppers into"}
              </h1>
            </div>
            {/* End Title */}
            ...
            <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-left">
                ...
                <div className="flex justify-center -space-x-3">
                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-gray-900 dark:ring-gray-800">
                    <span className="text-xs font-medium leading-none text-white uppercase">
                      {whoisHostingPageData?.hero?.leftNumber}
                    </span>
                  </span>
                </div>
                {/* End Avatar Group */}
              ...
              <div className="pt-5 sm:pt-0 sm:pl-5">
                <div className="text-lg font-semibold text-gray-800 dark:text-gray-900">
                  {whoisHostingPageData?.hero?.rightTitle}
                </div>
                <div className="text-sm text-gray-300">
                  {whoisHostingPageData?.hero?.rightDescription}
                </div>
              </div>
            </div>
            {/* End Avatar Group */}
              ...
              <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-xl shadow-lg  dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2] flex flex-col sm:flex-row align-center">
                ...
                {/* <div className="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] dark:border-gray-700">
                  <label
                    ...
                    className="block text-sm font-medium dark:text-white"
                  >
                    <span className="sr-only">Your email addresssdfds</span>
                  </label>
                  <input
                    type="email"
                    id="hs-hero-email-1"
