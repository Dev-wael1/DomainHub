...
export default function Cookie() {
  ...
  return (
    <div
      ...
      className={`hidden ${
        showCookie && "!block"
      }  fixed bottom-0 left-1/2 transform -translate-x-1/2 z-[60] mx-auto p-6`}
    >
      {/* Card */}
      <div className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div className="flex justify-between items-center gap-x-5 sm:gap-x-10">
          ...
          <button
            type="button"
            onClick={hideCookie}
            className="inline-flex bg-gray-200 rounded-full p-3 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-400"
