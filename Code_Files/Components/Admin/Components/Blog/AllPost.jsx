...
export default function AllPost() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => setData(res.data?.allPost));
  }, []);
                ...
                <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Create new post, edit or remove.
                    </p>
                  </div>
                  ...
                  <Button
                    as={Link}
                    href={`/admin/add-new-post?post_id=${uuid4()}`}
                  >
                    Add New Post
                  </Button>
                </div>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    {data?.map((x, i) => (
                      ...
                      >
                        <td className="h-px w-px whitespace-nowrap">
                          ...
                          >
                            <div className="px-6 py-2">
                              <span className="font-mono text-sm font-semibold text-blue-600 dark:text-blue-500">
                                {x?.title || "...."}
                              </span>
                            </div>
                          </a>
                        ...
                        <td className="h-px w-px whitespace-nowrap">
                          <a href={`/blog/${x?.permalink}`} target="_blank">
                            <button
                              className="block"
                              data-hs-overlay="#hs-ai-invoice-modal"
                            >
