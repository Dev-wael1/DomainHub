      ...
      <div className="flex w-full flex-col">
        ...
        >
          <Tab key="cta_1" title="CTA 1">
            <AdminCTA_1 dbCollection={"ai-generator"} item={"cta_1"} />
          </Tab>

          <Tab key="cta_2" title="CTA 2">
            <AdminCTA_2 dbCollection={"ai-generator"} item={"cta_2"} />
          </Tab>
          <Tab key="cta_3" title="CTA 3">
            <AdminCTA_3 dbCollection={"ai-generator"} item={"cta_3"} />
          </Tab>
          <Tab key="cta_4" title="CTA 4">
            <AdminCTA_4 dbCollection={"ai-generator"} item={"cta_4"} />
          </Tab>
          <Tab key="cta_5" title="CTA 5">
            <AdminCTA_5 dbCollection={"ai-generator"} item={"cta_5"} />
          </Tab>
          <Tab key="cta_6" title="CTA 6">
            <AdminCTA_6 dbCollection={"ai-generator"} item={"cta_6"} />
          </Tab>
          <Tab key="cta_7" title="CTA 7">
            <AdminCTA_7 dbCollection={"ai-generator"} item={"cta_7"} />
          </Tab>
          <Tab key="cta_8" title="CTA 8">
            <AdminCTA_8 dbCollection={"ai-generator"} item={"cta_8"} />
          </Tab>
          <Tab key="cta_9" title="CTA 9">
            <AdminCTA_9
              dbCollection={"ai-generator"}
              storagePath={"images/ai-generator/cta-9"}
            />
          </Tab>
        </Tabs>
      </div>
