      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="pricing 1" title="Pricing 1">
            <AdminPricing_1 dbCollection={"ai-generator"} item={"pricing_1"} />
          </Tab>
          <Tab key="pricing 2" title="Pricing 2">
            <AdminPricing_2 dbCollection={"ai-generator"} item={"pricing_2"} />
          </Tab>
          <Tab key="pricing 3" title="Pricing 3">
            <AdminPricing_3 dbCollection={"ai-generator"} item={"pricing_3"} />
          </Tab>
          <Tab key="pricing 4" title="Pricing 4">
            <AdminPricing_4 dbCollection={"ai-generator"} item={"pricing_4"} />
          </Tab>
          <Tab key="pricing 5" title="Pricing 5">
            <AdminPricing_5 dbCollection={"ai-generator"} item={"pricing_5"} />
          </Tab>
          <Tab key="pricing 6" title="Pricing 6">
            <AdminPricing_6 dbCollection={"ai-generator"} item={"pricing_6"} />
          </Tab>
          <Tab key="pricing 7" title="Pricing 7">
            <AdminPricing_7 dbCollection={"ai-generator"} item={"pricing_7"} />
          </Tab>
          <Tab key="pricing 8" title="Pricing 8">
            <AdminPricing_8 dbCollection={"ai-generator"} item={"pricing_8"} />
          </Tab>
          <Tab key="pricing 9" title="Pricing 9">
            <AdminPricing_9 dbCollection={"ai-generator"} item={"pricing_9"} />
          </Tab>
