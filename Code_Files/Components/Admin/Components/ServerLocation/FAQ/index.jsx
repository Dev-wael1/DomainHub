      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="FAQ_1" title="FAQ 1">
            <AdminFaq_1 dbCollection={"hosting-location"} item={"faq_1"} />
          </Tab>
          <Tab key="FAQ_2" title="FAQ 2">
            <AdminFaq_2 dbCollection={"hosting-location"} item={"faq_2"} />
          </Tab>
          <Tab key="FAQ_3" title="FAQ 3">
            <AdminFaq_3 dbCollection={"hosting-location"} item={"faq_3"} />
          </Tab>
          <Tab key="FAQ_4" title="FAQ 4">
            <AdminFaq_4 dbCollection={"hosting-location"} item={"faq_4"} />
          </Tab>
          <Tab key="FAQ_5" title="FAQ 5">
            <AdminFaq_5 dbCollection={"hosting-location"} item={"faq_5"} />
          </Tab>
          <Tab key="FAQ_6" title="FAQ 6">
            <AdminFaq_6 dbCollection={"hosting-location"} item={"faq_6"} />
          </Tab>
          <Tab key="FAQ_7" title="FAQ 7">
            <AdminFaq_7 dbCollection={"hosting-location"} item={"faq_7"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
