      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="banner_1" title="Ads 1">
            <AdminBannerAds_1 dbCollection={"reverse-ip"} item={"banner_1"} />
          </Tab>
          <Tab key="banner_2" title="Ads 2">
            <AdminBannerAds_2 dbCollection={"reverse-ip"} item={"banner_2"} />
          </Tab>
          <Tab key="banner_3" title="Ads 3">
            <AdminBannerAds_3 dbCollection={"reverse-ip"} item={"banner_3"} />
          </Tab>
          <Tab key="banner_4" title="Ads 4">
            <AdminBannerAds_4 dbCollection={"reverse-ip"} item={"banner_4"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
