      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="stats_1" title="Stats 1">
            <AdminStats_1 dbCollection={"best-vps-hosting"} item={"stats_1"} />
          </Tab>
          <Tab key="stats_2" title="Stats 2">
            <AdminStats_2 dbCollection={"best-vps-hosting"} item={"stats_2"} />
          </Tab>
          <Tab key="stats_3" title="Stats 3">
            <AdminStats_3 dbCollection={"best-vps-hosting"} item={"stats_3"} />
          </Tab>
          <Tab key="stats_4" title="Stats 4">
            <AdminStats_4 dbCollection={"best-vps-hosting"} item={"stats_4"} />
          </Tab>
          <Tab key="stats_5" title="Stats 5">
            <AdminStats_5 dbCollection={"best-vps-hosting"} item={"stats_5"} />
          </Tab>
          <Tab key="stats_6" title="Stats 6">
            <AdminStats_6 dbCollection={"best-vps-hosting"} item={"stats_6"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
