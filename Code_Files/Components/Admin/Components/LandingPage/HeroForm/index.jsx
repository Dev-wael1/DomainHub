      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="hero-1" title="Hero 1">
            <AdminHeroForm_1 dbCollection={"home-page"} item={"hero_form_1"} />
          </Tab>
          <Tab key="hero-2" title="Hero 2">
            <AdminHeroForm_2 dbCollection={"home-page"} item={"hero_form_2"} />
          </Tab>
          <Tab key="hero-3" title="Hero 3">
            <AdminHeroForm_3
              dbCollection={"home-page"}
              storagePath={"images/home-page/hero-form-3"}
            />
          </Tab>
          <Tab key="hero-4" title="Hero 4">
            <AdminHeroForm_4 dbCollection={"home-page"} item={"hero_form_4"} />
          </Tab>
          <Tab key="hero-5" title="Hero 5">
            <AdminHeroForm_5 dbCollection={"home-page"} item={"hero_form_5"} />
          </Tab>
          <Tab key="hero-6" title="Hero 6">
            <AdminHeroForm_6 dbCollection={"home-page"} item={"hero_form_6"} />
          </Tab>
          <Tab key="hero-7" title="Hero 7">
            <AdminHeroForm_7 dbCollection={"home-page"} item={"hero_form_7"} />
          </Tab>
          <Tab key="hero-8" title="Hero 8">
            <AdminHeroForm_8 dbCollection={"home-page"} item={"hero_form_8"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
