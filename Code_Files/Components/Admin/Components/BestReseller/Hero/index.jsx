      ...
      <div className="flex w-full flex-col">
        ...
        >
          <Tab key="hero_1" title="Hero 1">
            <HeroAdmin_1
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-1"}
            />
          </Tab>
          ...
          <Tab key="hero_4" title="Hero 4">
            <HeroAdmin_4
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-4"}
            />
          </Tab>
          <Tab key="hero_5" title="Hero 5">
            <HeroAdmin_5
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-5"}
            />
          </Tab>
          <Tab key="hero_6" title="Hero 6">
            <HeroAdmin_6
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-6"}
            />
          </Tab>
          <Tab key="hero_7" title="Hero 7">
            <HeroAdmin_7
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-7"}
            />
          </Tab>
          <Tab key="hero_8" title="Hero 8">
            <HeroAdmin_8
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-8"}
            />
          </Tab>
          ...
          <Tab key="hero_11" title="Hero 11">
            <HeroAdmin_11
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-11"}
            />
          </Tab>
          ...
          <Tab key="hero_13" title="Hero 13">
            <HeroAdmin_13
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-13"}
            />
          </Tab>
          <Tab key="hero_14" title="Hero 14">
            <HeroAdmin_14
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-14"}
            />
          </Tab>
          <Tab key="hero_15" title="Hero 15">
            <HeroAdmin_15
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-15"}
            />
          </Tab>
          <Tab key="hero_16" title="Hero 16">
            <HeroAdmin_16
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-16"}
            />
          </Tab>
          <Tab key="hero_17" title="Hero 17">
            <HeroAdmin_17
              dbCollection={"best-reseller-hosting"}
              storagePath={"images/best-reseller-hosting/hero-17"}
            />
          </Tab>
