      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="feature_1" title="Feature 1">
            <AdminFeatures_1 dbCollection={"bulk-whois"} item={"features_1"} />
          </Tab>
          <Tab key="feature_2" title="Feature 2">
            <AdminFeatures_2 dbCollection={"bulk-whois"} item={"features_2"} />
          </Tab>
          <Tab key="feature_3" title="Feature 3">
            <AdminFeatures_3 dbCollection={"bulk-whois"} item={"features_3"} />
          </Tab>
          <Tab key="feature_4" title="Feature 4">
            <AdminFeatures_4 dbCollection={"bulk-whois"} item={"features_4"} />
          </Tab>
