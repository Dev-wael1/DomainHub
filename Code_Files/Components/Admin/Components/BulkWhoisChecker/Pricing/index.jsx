      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="pricing 1" title="Pricing 1">
            <AdminPricing_1 dbCollection={"bulk-whois"} item={"pricing_1"} />
          </Tab>
          <Tab key="pricing 2" title="Pricing 2">
            <AdminPricing_2 dbCollection={"bulk-whois"} item={"pricing_2"} />
          </Tab>
          <Tab key="pricing 3" title="Pricing 3">
            <AdminPricing_3 dbCollection={"bulk-whois"} item={"pricing_3"} />
          </Tab>
          <Tab key="pricing 4" title="Pricing 4">
            <AdminPricing_4 dbCollection={"bulk-whois"} item={"pricing_4"} />
          </Tab>
          <Tab key="pricing 5" title="Pricing 5">
            <AdminPricing_5 dbCollection={"bulk-whois"} item={"pricing_5"} />
          </Tab>
          <Tab key="pricing 6" title="Pricing 6">
            <AdminPricing_6 dbCollection={"bulk-whois"} item={"pricing_6"} />
          </Tab>
          <Tab key="pricing 7" title="Pricing 7">
            <AdminPricing_7 dbCollection={"bulk-whois"} item={"pricing_7"} />
          </Tab>
          <Tab key="pricing 8" title="Pricing 8">
            <AdminPricing_8 dbCollection={"bulk-whois"} item={"pricing_8"} />
          </Tab>
          <Tab key="pricing 9" title="Pricing 9">
            <AdminPricing_9 dbCollection={"bulk-whois"} item={"pricing_9"} />
          </Tab>
          <Tab key="pricing 10" title="Pricing 10">
            <AdminPricing_10 dbCollection={"bulk-whois"} item={"pricing_10"} />
          </Tab>
          <Tab key="pricing 11" title="Pricing 11">
            <AdminPricing_11 dbCollection={"bulk-whois"} item={"pricing_11"} />
          </Tab>
          <Tab key="pricing 12" title="Pricing 12">
            <AdminPricing_12 dbCollection={"bulk-whois"} item={"pricing_12"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
