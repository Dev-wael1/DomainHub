      ...
      <div className="flex w-full flex-col">
        ...
        >
          <Tab key="hero_1" title="Hero 1">
            <HeroAdmin_1
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-1"}
            />
          </Tab>
          <Tab key="hero_2" title="Hero 2">
            <HeroAdmin_2 item={"hero_2"} dbCollection={"random-letter"} />
          </Tab>
          <Tab key="hero_3" title="Hero 3">
            <HeroAdmin_3 item={"hero_3"} dbCollection={"random-letter"} />
          </Tab>
          <Tab key="hero_4" title="Hero 4">
            <HeroAdmin_4
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-4"}
            />
          </Tab>
          <Tab key="hero_5" title="Hero 5">
            <HeroAdmin_5
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-5"}
            />
          </Tab>
          <Tab key="hero_6" title="Hero 6">
            <HeroAdmin_6
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-6"}
            />
          </Tab>
          <Tab key="hero_7" title="Hero 7">
            <HeroAdmin_7
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-7"}
            />
          </Tab>
          <Tab key="hero_8" title="Hero 8">
            <HeroAdmin_8
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-8"}
            />
          </Tab>
          <Tab key="hero_10" title="Hero 10">
            <HeroAdmin_10 item={"hero_10"} dbCollection={"random-letter"} />
          </Tab>
          <Tab key="hero_11" title="Hero 11">
            <HeroAdmin_11
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-11"}
            />
          </Tab>
          <Tab key="hero_12" title="Hero 12">
            <HeroAdmin_12 item={"hero_12"} dbCollection={"random-letter"} />
          </Tab>
          <Tab key="hero_13" title="Hero 13">
            <HeroAdmin_13
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-13"}
            />
          </Tab>
          <Tab key="hero_14" title="Hero 14">
            <HeroAdmin_14
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-14"}
            />
          </Tab>
          <Tab key="hero_15" title="Hero 15">
            <HeroAdmin_15
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-15"}
            />
          </Tab>
          <Tab key="hero_16" title="Hero 16">
            <HeroAdmin_16
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-16"}
            />
          </Tab>
          <Tab key="hero_17" title="Hero 17">
            <HeroAdmin_17
              dbCollection={"random-letter"}
              storagePath={"images/random-letter/hero-17"}
            />
          </Tab>
          <Tab key="hero_18" title="Hero 18">
            <HeroAdmin_18 item={"hero_18"} dbCollection={"random-letter"} />
          </Tab>
          <Tab key="hero_19" title="Hero 19">
            <HeroAdmin_19 item={"hero_19"} dbCollection={"random-letter"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
