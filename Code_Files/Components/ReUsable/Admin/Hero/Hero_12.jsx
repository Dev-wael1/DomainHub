...
import Hero_12 from "../../Front/Hero/Hero_12";
export default function HeroAdmin_12({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.hero_12) {
          setEnable(res.data?.hero_12?.enable);
          setTitle(res.data?.hero_12?.title);
          setDesc(res.data?.hero_12?.desc);
          setButtonText(res.data?.hero_12?.buttonText);
          setButtonLink(res.data?.hero_12?.buttonLink);
          setTopButtonText(res.data?.hero_12?.topButtonText);
          setTopButtonLink(res.data?.hero_12?.topButtonLink);
        }
      });
  }, []);
