...
import Stats_2 from "../../Front/Stats/Stats_2";

export default function AdminStats_2({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.stats_2) {
          setEnable(res.data?.stats_2?.enable);
          setTitle(res.data?.stats_2?.title);
          setDesc(res.data?.stats_2?.desc);

          setStat1Number(res.data?.stats_2?.stat1Number);
          setStat1Desc(res.data?.stats_2?.stat1Desc);

          setStat2Number(res.data?.stats_2?.stat2Number);
          setStat2Desc(res.data?.stats_2?.stat2Desc);

          setStat3Number(res.data?.stats_2?.stat3Number);
          setStat3Desc(res.data?.stats_2?.stat3Desc);
        }
      });
  }, []);
