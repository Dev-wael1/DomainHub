...
import Feature_2 from "../../Front/Features/Feature_2";
import Feature_3 from "../../Front/Features/Feature_3";
import Feature_4 from "../../Front/Features/Feature_4";

export default function AdminFeatures_4({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.features_4) {
          setEnable(res.data?.features_4?.enable);
          setTitle(res.data?.features_4?.title);
          setDesc(res.data?.features_4?.desc);

          setTitle1(res.data?.features_4?.title1);
          setDesc1(res.data?.features_4?.setDesc1);

          setTitle2(res.data?.features_4?.title2);
          setDesc2(res.data?.features_4?.setDesc2);

          setTitle3(res.data?.features_4?.title3);
          setDesc3(res.data?.features_4?.setDesc3);

          setTitle4(res.data?.features_4?.title4);
          setDesc4(res.data?.features_4?.setDesc4);

          setTitle5(res.data?.features_4?.title5);
          setDesc5(res.data?.features_4?.setDesc5);

          setTitle6(res.data?.features_4?.title6);
          setDesc6(res.data?.features_4?.setDesc6);
        }
      });
  }, []);
