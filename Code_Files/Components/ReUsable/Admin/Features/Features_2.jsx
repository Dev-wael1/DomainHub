...
export default function AdminFeatures_2({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.features_2) {
          setEnable(res.data?.features_2?.enable);
          setTitle(res.data?.features_2?.title);
          setDesc(res.data?.features_2?.desc);

          setTitle1(res.data?.features_2?.title1);
          setDesc1(res.data?.features_2?.setDesc1);

          setTitle2(res.data?.features_2?.title2);
          setDesc2(res.data?.features_2?.setDesc2);

          setTitle3(res.data?.features_2?.title3);
          setDesc3(res.data?.features_2?.setDesc3);

          setTitle4(res.data?.features_2?.title4);
          setDesc4(res.data?.features_2?.setDesc4);

          setTitle5(res.data?.features_2?.title5);
          setDesc5(res.data?.features_2?.setDesc5);

          setTitle6(res.data?.features_2?.title6);
          setDesc6(res.data?.features_2?.setDesc6);
        }
      });
  }, []);
