...
export default function HeroForm_7({
  data = { enable: false },
  homePage,
  aiGenerator,
  whois,
              ...
              <div className="text-center">
                ...
                <div className="mt-7 sm:mt-12 mx-auto max-w-3xl relative">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="relative z-10 flex space-x-3 p-3 bg-white border rounded-xl shadow-md hover:shadow-gray-100 dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2]">
