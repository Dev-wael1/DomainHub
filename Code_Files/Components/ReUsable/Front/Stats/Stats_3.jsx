...
export default function Stats_3({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <section className="flex flex-col py-10">
          <p className="font-semibold text-2xl md:text-3xl text-center">
            {data?.title || " Our Outstanding Achievements"}
          </p>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 place-items-center w-full mx-auto max-w-7xl px-5">
            <Card
              isPressable
              className="flex flex-col justify-center items-center bg-gradient-to-r from-gray-100 to-gray-300 border dark:border-gray-700 transition duration-200 ease-in-out shadow-lg hover:shadow-2xl  cursor-pointer dark:bg-gradient-to-r dark:from-gray-700 dark:via-gray-900 dark:to-black px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center"
            >
              <div className="flex flex-row justify-center items-center">
                ...
                <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">
                  {data?.stat1Number || "75K+"}
                </p>
              </div>
              <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">
                {data?.stat1Desc || "Expert Chat Call Minutes"}
              </p>
            </Card>
            <Card
              isPressable
              className="flex flex-col justify-center items-center bg-gradient-to-r from-gray-100 to-gray-300 border dark:border-gray-700 shadow-lg hover:shadow-2xl cursor-pointer dark:bg-gradient-to-r dark:from-gray-700 dark:via-gray-900 dark:to-black px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center"
            >
              <div className="flex flex-row justify-center items-center">
                <svg
                  className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]"
                ...
                <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">
                  {data?.stat2Number || "4.9"}
                </p>
              </div>
              <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">
                {data?.stat2Desc || "Average Expert Rating"}
              </p>
            </Card>
            <Card
              isPressable
            ...
            >
              <div className="flex flex-row justify-center items-center">
                ...
                <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">
                  {data?.stat3Number || "8900+"}
                </p>
              </div>
              <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">
                {data?.stat3Desc || " Sessions Completed"}
              </p>
            </Card>
            <Card
              isPressable
            ...
            >
              <div className="flex flex-row justify-center items-center">
                ...
                <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">
                  {data?.stat4Number || "1.5M+"}
                </p>
              </div>
              <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">
                {data?.stat4Desc || " App Downloads"}
              </p>
            </Card>
          </div>
        </section>
