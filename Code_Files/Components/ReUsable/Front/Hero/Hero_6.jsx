...
export default function Hero_6({ data = { enable: false } }) {
  const features = [
    {
      name: data?.iconText1 || "Trusted",
      icon: (
        <svg
    ...
    {
      name: data?.iconText2 || "Over 50+ videos",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
    ...
    {
      name: data?.iconText3 || "400 ratings",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
        ...
        <section className="h-screen">
          <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
            <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
              ...
              <h1 className="text-4xl text-gray-800 dark:text-gray-400 font-extrabold mx-auto md:text-5xl">
                {data?.title ||
              ...
              <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
                ...
                >
                  {data?.leftButtonText || "Browse courses"}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
