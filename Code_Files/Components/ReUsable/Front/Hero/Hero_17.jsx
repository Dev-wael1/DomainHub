...
export default function Hero_17({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <section className="relative overflow-hidden">
          <svg
            className="absolute h-screen rotate-180"
            fill="none"
          ...
          <section
            style={{
              backgroundImage: "linear-gradient(180deg, #651eea, #7f2aec 43%)",
            }}
          >
            <div className="relative items-center w-full px-5 pt-12 mx-auto max-w-7xl lg:px-16 lg:pt-36 md:px-12">
              <div className="mx-auto text-center">
                <div>
                  <p className="text-4xl font-extrabold tracking-tight text-black md:text-6xl md:text-white">
                    {data?.title ||
                      "A set of 28 dark &amp; light mesh gradients in 5k res"}
                  </p>
                  <p className="max-w-2xl mx-auto mt-8 text-base text-black lg:text-white lg:text-xl">
                    {data?.desc ||
                ...
                <div className="flex flex-col justify-center gap-3 mt-10 sm:flex-row">
                  <a
                    target="_blank"
                    className="items-center text-white focus:outline-none inline-flex justify-center hover:text-white bg-[#151623] duration-200 focus-visible:outline-black focus-visible:ring-black font-medium hover:bg-[#151623]/20 md:w-auto px-16 py-3 rounded-xl text-center w-full"
                    href={data?.leftButtonLink || "#"}
                  >
                    {data?.leftButtonText || "Buy for $3"}
                  </a>
                </div>
              </div>
              <div className="relative items-center w-full mx-auto mt-12 max-w-7xl">
                <img
                  alt=""
                  className="w-full rounded-t-3xl object-cover object-bottom h-[75vh]"
                  src={
