...
export default function CTA_6({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <>
          <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-gray-700 via-gray-900 dark:to-black px-6 py-16 text-center border border-white dark:border-gray-800 shadow-xl">
            <div className="relative m-auto max-w-xl">
              ...
              <h2 className="mt-4 font-dm-sans text-mobile-h3 font-semibold leading-snug sm:text-mobile-h2 md:text-desktop-h2 text-center">
                {data?.starRatingText || "An absolute 5/5 rating"}
              </h2>
            ...
            <div className="mt-6 flex flex-col items-center justify-center space-y-3">
              <a href={data?.firstButtonLink || "#"} target="_blank">
                <Button size="lg" color="default" className="px-14" radius="sm">
                  {data?.firstButtonText || "Product of the Day"}
                </Button>
              </a>
              <a href={data?.secondButtonLink || "#"} target="_blank">
                <Button size="lg" color="warning" className="px-14" radius="sm">
                  {data?.secondButtonText || "Product of the Day"}
                </Button>
              </a>
            </div>
          </div>
