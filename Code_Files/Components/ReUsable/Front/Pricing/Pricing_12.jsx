export default function Pricing_12({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <>
          <>
            <div className="flex flex-col text-center w-full my-8">
              <div className="w-40 mx-auto">
                <h2 className="font-heading mb-4 bg-orange-100 text-orange-800 px-4 py-2 rounded-lg md:w-36 md:mx-auto text-xs font-semibold tracking-widest uppercase title-font text-center">
                  Pricing
                </h2>
              </div>
