export default function Pricing_2({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <>
            ...
            >
              <g clipPath="url(#clip0_17_23)">
                <g filter="url(#filter0_f_17_23)">
                  <path d="M271.4 0H400V322.2L320 290L271.4 0Z" fill="#fff" />
                  <path
                    d="M400 322.2V400H320H244L320 290L400 322.2Z"
                    fill="#fff"
                  />
                  <path d="M244 400H0V166L320 290L244 400Z" fill="#fff" />
                  <path d="M0 0H271.4L320 290L0 166V0Z" fill="#fff" />
                </g>
              </g>
              <defs>
                <filter
            ...
            <div className="relative flex flex-col items-center justify-center max-w-6xl px-8 py-12 mx-auto lg:py-24">
              <div>
                ...
                <p className="mt-8 text-4xl font-semibold tracking-tight text-white lg:text-5xl">
                  Equip your business
                  <span className="md:block"> with world class software</span>
                </p>
                  ...
                  <div className="flex flex-col">
                    <div className="p-8 rounded-3xl bg-[#1c1f29] ring-1 ring-white/10 shadow-2xl">
                      ...
                      <p className="mt-8 text-sm font-medium text-gray-300">
                        This plan is ideal for individual users and hobbyists
                        who are looking for essential functionalities to
                        support.
                      </p>
                      <div className="flex mt-6">
                        <a
