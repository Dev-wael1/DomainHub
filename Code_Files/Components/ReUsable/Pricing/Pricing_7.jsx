...
import Pricing_7 from "../Front/Pricing/Pricing_7";

export default function AdminPricing_7({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.pricing_7) {
          setEnable(res.data?.pricing_7?.enable);
          setTitle(res.data?.pricing_7?.title);
          setDesc(res.data?.pricing_7?.desc);

          setPricing1Title(res.data?.pricing_7?.pricing1Title);
          setPricing1Description(res.data?.pricing_7?.pricing1Description);
          setPricing1(res.data?.pricing_7?.pricing1);
          setPricing1ButtonText(res.data?.pricing_7?.pricing1ButtonText);
          setPricing1ButtonLink(res.data?.pricing_7?.pricing1ButtonLink);
          setPricing1Features(res.data?.pricing_7?.pricing1Features);

          setPricing2Title(res.data?.pricing_7?.pricing2Title);
          setPricing2Description(res.data?.pricing_7?.pricing2Description);
          setPricing2(res.data?.pricing_7?.pricing2);
          setPricing2ButtonText(res.data?.pricing_7?.pricing2ButtonText);
          setPricing2ButtonLink(res.data?.pricing_7?.pricing2ButtonLink);
          setPricing2Features(res.data?.pricing_7?.pricing2Features);
        }
      });
  }, []);
