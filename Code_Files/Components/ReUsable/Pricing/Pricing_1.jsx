...
export default function AdminPricing_1({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.pricing_1) {
          setEnable(res.data?.pricing_1?.enable);
          setPricing1Title(res.data?.pricing_1?.pricing1Title);
          setPricing1Description(res.data?.pricing_1?.pricing1Description);
          setPricing1(res.data?.pricing_1?.pricing1);
          setPricing1ButtonText(res.data?.pricing_1?.pricing1ButtonText);
          setPricing1ButtonLink(res.data?.pricing_1?.pricing1ButtonLink);
          setPricing1Features(res.data?.pricing_1?.pricing1Features);

          setPricing2Title(res.data?.pricing_1?.pricing2Title);
          setPricing2Description(res.data?.pricing_1?.pricing2Description);
          setPricing2(res.data?.pricing_1?.pricing2);
          setPricing2ButtonText(res.data?.pricing_1?.pricing2ButtonText);
          setPricing2ButtonLink(res.data?.pricing_1?.pricing2ButtonLink);
          setPricing2Features(res.data?.pricing_1?.pricing2Features);
        }
      });
  }, []);
