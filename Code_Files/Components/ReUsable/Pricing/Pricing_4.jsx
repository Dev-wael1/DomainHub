...
import Pricing_4 from "../Front/Pricing/Pricing_4";

export default function AdminPricing_4({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.pricing_4) {
          setEnable(res.data?.pricing_4?.enable);
          setTitle(res.data?.pricing_4?.title);
          // setDesc(res.data?.pricing_4?.desc);

          setPricing1Title(res.data?.pricing_4?.pricing1Title);
          setPricing1Description(res.data?.pricing_4?.pricing1Description);
          setPricing1(res.data?.pricing_4?.pricing1);
          setPricing1ButtonText(res.data?.pricing_4?.pricing1ButtonText);
          setPricing1ButtonLink(res.data?.pricing_4?.pricing1ButtonLink);
          setPricing1Features(res.data?.pricing_4?.pricing1Features);

          setPricing2Title(res.data?.pricing_4?.pricing2Title);
          setPricing2Description(res.data?.pricing_4?.pricing2Description);
          setPricing2(res.data?.pricing_4?.pricing2);
          setPricing2ButtonText(res.data?.pricing_4?.pricing2ButtonText);
          setPricing2ButtonLink(res.data?.pricing_4?.pricing2ButtonLink);
          setPricing2Features(res.data?.pricing_4?.pricing2Features);

          setPricing3Title(res.data?.pricing_4?.pricing3Title);
          setPricing3Description(res.data?.pricing_4?.pricing3Description);
          setPricing3(res.data?.pricing_4?.pricing3);
          setPricing3ButtonText(res.data?.pricing_4?.pricing3ButtonText);
          setPricing3ButtonLink(res.data?.pricing_4?.pricing3ButtonLink);
          setPricing3Features(res.data?.pricing_4?.pricing3Features);
        }
      });
  }, []);
