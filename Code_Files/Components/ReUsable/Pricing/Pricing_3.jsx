...
import Pricing_3 from "../Front/Pricing/Pricing_3";

export default function AdminPricing_3({ dbCollection, item }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (res.data?.pricing_3) {
          setEnable(res.data?.pricing_3?.enable);
          // setTitle(res.data?.pricing_3?.title);
          // setDesc(res.data?.pricing_3?.desc);

          setPricing1Title(res.data?.pricing_3?.pricing1Title);
          setPricing1Description(res.data?.pricing_3?.pricing1Description);
          setPricing1(res.data?.pricing_3?.pricing1);
          setPricing1ButtonText(res.data?.pricing_3?.pricing1ButtonText);
          setPricing1ButtonLink(res.data?.pricing_3?.pricing1ButtonLink);
          setPricing1Features(res.data?.pricing_3?.pricing1Features);

          setPricing2Title(res.data?.pricing_3?.pricing2Title);
          setPricing2Description(res.data?.pricing_3?.pricing2Description);
          setPricing2(res.data?.pricing_3?.pricing2);
          setPricing2ButtonText(res.data?.pricing_3?.pricing2ButtonText);
          setPricing2ButtonLink(res.data?.pricing_3?.pricing2ButtonLink);
          setPricing2Features(res.data?.pricing_3?.pricing2Features);

          setPricing3Title(res.data?.pricing_3?.pricing3Title);
          setPricing3Description(res.data?.pricing_3?.pricing3Description);
          setPricing3(res.data?.pricing_3?.pricing3);
          setPricing3ButtonText(res.data?.pricing_3?.pricing3ButtonText);
          setPricing3ButtonLink(res.data?.pricing_3?.pricing3ButtonLink);
          setPricing3Features(res.data?.pricing_3?.pricing3Features);
        }
      });
  }, []);
