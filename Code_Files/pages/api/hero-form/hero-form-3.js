    ...
    switch (req.method) {
      case "POST":
        upload.single("heroImage")(req, res, async (_err) => {
          ...
          const { title, desc, enable, buttonText } = req.body;
          ...
          if (isLoggedIn(token)) {
            ...
            const currentImage = await client
              ...
              .findOne({}, { projection: { _id: 0, hero_form_3: 1 } });
            ...
            const updateData = {
              ...
              heroImage: currentImage?.hero_form_3?.heroImage,
            };
